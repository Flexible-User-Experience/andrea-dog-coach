...
final readonly class AssetsManager
{
    ...
    public const string MIME_IMAGE_JPG_TYPE = 'image/jpg';
    public const string MIME_IMAGE_JPEG_TYPE = 'image/jpeg';
    public const string MIME_IMAGE_PNG_TYPE = 'image/png';
    public const string MIME_IMAGE_GIF_TYPE = 'image/gif';
